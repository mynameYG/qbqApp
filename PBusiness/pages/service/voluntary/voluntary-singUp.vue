	...
	<view>
		<form @submit="formSubmit">
			...
			<!-- <view class="popup-btn flex flexmid">
				...
				<view class="popup-btn-item flex1">
					<button class="popup-confirm" form-type="submit">提交</button>
				</view>
			</view> -->
		</form>
	</view>
		...
		methods: {
			cancle() {
				...
				for (let page of pages) {
					index++;
				  if (page.route === 'PBusiness/pages/service/voluntary/voluntary-detail') {
					break;
				  }
				} 
			...
			formSubmit: function(e) {
				...
				e.detail.value.volunteerServiceId = this.id; 
				...
				if (checkRes) {
					...
					//return false
					this.$http.post(`/mobile/party/vservice/signUp`,e.detail.value).then(res =>{
